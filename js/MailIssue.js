...
let app = new Vue({
    ...
    , data: {   
        ...
        team: "",        
        issues:[],
        devices:[{id:1,type:"Android"},{id:2,type:"IOS"}],
  ...
  switch(type)
{
    ...
    break;
    case 1:
        vm.recordData.issueTypeID =event.target.value;
        console.log(vm.recordData.issueTypeID);
    break;
    case 2:
...
//   vm.recordData.recordNo = url.searchParams.get('key');
//   console.log(vm.recordData.recordNo)
//},
ClearFun:function()
{ 
  let vm = this;
    ...
    .then(response => {
        ...
        switch(response.data.code)
        {
            case 200:
                ...
                .then (function(){location.href="issue.html"; });
            break;
...
{  
    ...
    axios.post(domainUrl+`issue`,vm.recordData)
    .then(response => {
         console.log('新增資料');
         console.log(response.data.data);             
         switch(response.data.code)
